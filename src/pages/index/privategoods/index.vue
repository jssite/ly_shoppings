  ...
  <div class="backgroundView">
    ...
    <div class="page_content_box" v-if="is_show_data">
      <div class="page_content"  v-if="pro_list_info.length">
        <div
          @click.stop="gotoGoodsDetail(index)"
          class="pro_content"
          v-for="(item, index) in pro_list_info"
          :key="index"
        >
...
export default {
  ...
  methods: {
    ...
    funcGetProductInfo() {
      daGuanRecommentGoods(this.requset_info).then(res => {
