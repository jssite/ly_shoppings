<template>
    <div class="filter">
        ...
        <div class="filter_title">
            <span>品类</span>
            <span class="padding_10" @click="funcShowPinl">
                <template v-if="isHidePinl == 6">
        ...
        <div class="filter_title">
            <span>品牌</span>
            <span class="padding_10" @click="funcShowPinp">
                <template v-if="isHidePinp == 6">
                    <img class="filter_arrow" src="../../../../static/images/public_arrow_down.png" alt="">
                </template>
                <template v-else>
                    <img class="filter_arrow" src="../../../../static/images/public_arrow_up.png" alt="">
...
export default {
    ...
    methods: {
        ...
        funcShowPinl(){
            this.isHidePinl==6?this.isHidePinl=this.search_filter.initCategoryList.length:this.isHidePinl=6;
        },
        funcShowPinp(){
            this.isHidePinp==6?this.isHidePinp=this.search_filter.initMfctnamesList.length:this.isHidePinp=6;
        },
        //选中状态
